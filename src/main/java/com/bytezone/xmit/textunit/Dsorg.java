...
public class Dsorg extends TextUnit {
  ...
  public static final int VSAM = 0x0008; // VSAM
  public static final int PDS = 0x0200; // partioned organisation
  public static final int PS = 0x4000; // physical sequential
