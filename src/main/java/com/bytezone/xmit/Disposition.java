...
public class Disposition {
  ...
  private static final String[] recfmTypes = {"?", "V", "F", "U"};
  ...
  public Disposition(ControlRecord inmr02) {
    ...
    blksize = (int) ((TextUnitNumber) inmr02.getTextUnit(TextUnit.INMBLKSZ)).getNumber();
  ...
  public String getRecfm() {
    ...
    if ((recfm & 0x1000) != 0) recfmText += "B";
    int carriageControl = (recfm & 0x0600) >> 9;
    if (carriageControl == 1 || carriageControl == 2) recfmText += "A";
