...
public class XmitApp extends AppBase {
  ...
  protected Parent createContent() {
    ...
    saveStateList.addAll(
        Arrays.asList(
            filterManager, outputTabPane, fileMenu, viewMenu, xmitTree, tableTabPane, fontManager));
  ...
  void changeRootFolder() {
    ...
    } else xmitStatusBar.setStatusMessage("Root folder unchanged");
  }
  ...
  private boolean setRootFolder() {
    ...
    else directoryChooser.setInitialDirectory(new File(rootFolderName));
