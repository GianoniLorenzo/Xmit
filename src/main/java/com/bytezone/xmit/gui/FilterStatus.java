...
class FilterStatus implements SaveState {
  ...
  void set(
      String filterValue, boolean filterExclusion, boolean filterReverse, boolean filterActive) {
  ...
  public String toString() {
    ...
    String text =
        String.format("Filter value.... %s%n", filterValue)
            + String.format("Exclusion....... %s%n", filterExclusion)
            + String.format("Reverse......... %s%n", filterReverse)
            + String.format("Active.......... %s", filterActive);
