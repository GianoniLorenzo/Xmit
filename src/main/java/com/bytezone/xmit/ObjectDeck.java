      ...
      switch (recordType) {
        case "ESD":
          ...
          for (int i = 0; i < fieldCount; i++) {
            ...
            System.out.printf(
                "        %s  %02X  %06X  %02X  %06X%n", name, esdCode, address, flag, length);
            p += 16;
          }
          break;
        ...
        case "TXT":
          ...
          System.out.printf(
              "%s %s %06X %02X %02X %s%n", recordType, deckId, address, byteCount, esdid, text);
          break;
        ...
        case "RLD":
          ...
          while (fieldCount > 0) {
            ...
            if (fieldCount > 4) {
              ...
              System.out.printf("             %04X %04X %02X %06X%n", rel, pos, flag, address);
              fieldCount -= 8;
              p += 8;
            } else {
        ...
        case "END":
          ...
          System.out.printf(
              "%s %s %06X %04X %-8s %d %s %n",
              recordType, deckId, entryAddress, entryPoint, name, idr2, text);
          break;
